...
namespace FactionColonies
{
    ...
    public class FCOptionWindow : Window
    {
        ...
        public FCOptionWindow(FCEventDef evt, FCEvent parentEvent)
        {
            ...
            this.desc = TextUtil.ResolveFactionTokens(evt.optionDescription.NullOrEmpty() ? evt.desc : evt.optionDescription);
        ...
        private void MeasureLayout()
        {
            ...
            for (int i = 0; i < options.Count; i++)
            {
                ...
                cachedOptionLabelHeights[i] = Text.CalcHeight(TextUtil.ResolveFactionTokens(measureLabel), labelWidth);
            }
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            for (int i = 0; i < options.Count; i++)
            {
                ...
                Text.Font = GameFont.Small;
                Text.Anchor = TextAnchor.UpperLeft;
                UIUtil.DrawColoredLabel(new Rect(innerX, innerY, innerW, cachedOptionLabelHeights[i]), TextUtil.ResolveFactionTokens(displayLabel), available ? Color.white : new Color(0.5f, 0.5f, 0.5f));
