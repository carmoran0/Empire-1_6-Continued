...
namespace FactionColonies
{
    public class FCWindow_CaravanTypePicker : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Rect scrollViewRect = new Rect(innerRect.x, innerRect.y, contentWidth,
                Mathf.Max(viewHeight, innerRect.height));
        ...
        private void BuildEntries()
        {
            ...
            // Exotic
            bool exoticUnlocked = faction.factionLevel >= 4 || faction.HasTrait(FCPolicyDefOf.mercantile);
            entries.Add(new CaravanTypeEntry
            {
                typeId = "Exotic",
